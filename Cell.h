...
class Cell
{
    private:
        ...
        Array2D<bool> * lethal_sat_N; // array of which bins have lethal collisions for satellite types
        Array2D<bool> * lethal_rb_N; // array of which bins have lethal collisions for rocket types
        bool * ascending; // whether or not each satellite type is ascending
        Array2D<bool> trackable;
