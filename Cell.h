...
class Cell
{
    private:
        ...
        Array2D<double> * sigma_s_km; // cross-section of the satellite types (km^2)
        ...
        Array2D<double> * sigma_rb_km; // cross-section of the rocket bodies (km^2)
        ...
        double * logL_ave; // middle of each bin, logarithmic
        size_t num_L; // number of length bins
        double * chi_edges; // edges of the chi bins
        double * chi_ave; // middle of each bin
        ...
        vector<Array2D<bool> *> * cat_sat_N; // array of which bins have catestrophic collisions for satellite types
        vector<Array2D<bool> *> * cat_rb_N; // array of which bins have catestrophic for rocket types
